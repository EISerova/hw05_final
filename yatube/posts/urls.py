...
from .views import (AddCommentView, FollowListView, GroupListView,
                    IndexListView, PostCreateView, PostDetailView,
                    PostEditView, ProfileFollowView, ProfileListView,
                    ProfileUnfollowView)
...
urlpatterns = [
    ...
    path(
        ...
        PostEditView.as_view(), name='post_edit'
    ),
    path(
